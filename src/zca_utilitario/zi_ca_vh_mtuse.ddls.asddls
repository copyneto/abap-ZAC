@AbapCatalog.sqlViewName: 'ZVCA_MTUSE'
  ...
  association [0..1] to I_Language as _Language on $projection.Language = _Language.Language
{
  ...
  key cast ( substring( Base.domvalue_l, 1, 1 ) as j_1bmatuse preserving type ) as Mtuse,
