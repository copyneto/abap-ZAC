...
@EndUserText.label: 'Help Search - Status do documento'
...
define view entity ZI_CA_VH_DOCSTA
...
{
      @ObjectModel.text.element: ['StatusDocText']
      @Search.ranking: #MEDIUM
      @Search.defaultSearchElement: true
      @Search.fuzzinessThreshold: 0.8
  key cast( Domain.domvalue_l as j_1bnfedocstatus ) as StatusDoc,
      @Semantics.text: true
      @Search.defaultSearchElement: true
      @Search.ranking: #HIGH
