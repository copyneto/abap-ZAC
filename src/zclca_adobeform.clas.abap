...
CLASS zclca_adobeform DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
       "!Classe de mensagens utilizada para a geração dos erros através da classe zcxca_adobe_error
       gc_error_class TYPE symsgid VALUE 'ZCA_ADOBEFORM'.

    METHODS:
      "! Realiza a instância da classe representando o form a ser gerado
      "! @parameter iv_formname | Nome do AdobeForm
      "! @raising zcxca_adobe_error | Erro caso o form não exista no ambiente
      constructor IMPORTING iv_formname TYPE fpname
                  RAISING   zcxca_adobe_error,
      ...
      "! @raising zcxca_adobe_error | Erro, caso o parâmetro informado não exista na interface do form
      ...
      "! @raising zcxca_adobe_error | Erro na situação de haver algum erro durante a impressão
      ...
      "! @raising zcxca_adobe_error | Erro caso não seja possível gerar o PDF
      ...
      "! @raising zcxca_adobe_error | Erro se ocorrer problemas ao encerrar o job de impressão.
      close_job  RAISING zcxca_adobe_error.
  ...
  PRIVATE SECTION.
    ...
    METHODS:
      ...
      "! @raising zcxca_adobe_error | Erro se ocorrer algum problema durante a abertura do job ou haja parâmetros inválidos
      open_job RAISING zcxca_adobe_error,
      ...
      "! @raising zcxca_adobe_error | Erro na geração do form
...
CLASS ZCLCA_ADOBEFORM IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    TRY.
      ...
      CATCH cx_fp_api_repository cx_fp_api_usage cx_fp_api_internal.
        RAISE EXCEPTION TYPE zcxca_adobe_error
          EXPORTING
