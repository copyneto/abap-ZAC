*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVCA_STATUS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVCA_STATUS         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVCA_STATUS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVCA_STATUS_EXTRACT
TOTAL = ZVCA_STATUS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVCA_STATUS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVCA_STATUS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVCA_STATUS_EXTRACT
TOTAL = ZVCA_STATUS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVCA_STATUS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVCA_STATUS'
...
TOTAL = ZVCA_STATUS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVCA_STATUS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVCA_STATUS-UPD_FLAG NE SPACE.
