*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVCA_CENARIO
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVCA_CENARIO        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVCA_CENARIO'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVCA_CENARIO_EXTRACT
TOTAL = ZVCA_CENARIO_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVCA_CENARIO'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVCA_CENARIO-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVCA_CENARIO_EXTRACT
TOTAL = ZVCA_CENARIO_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVCA_CENARIO-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVCA_CENARIO'
...
TOTAL = ZVCA_CENARIO_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVCA_CENARIO-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVCA_CENARIO-UPD_FLAG NE SPACE.
