*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVCA_METRICAS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVCA_METRICAS       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVCA_METRICAS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVCA_METRICAS_EXTRACT
TOTAL = ZVCA_METRICAS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVCA_METRICAS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVCA_METRICAS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVCA_METRICAS_EXTRACT
TOTAL = ZVCA_METRICAS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVCA_METRICAS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVCA_METRICAS'
...
TOTAL = ZVCA_METRICAS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVCA_METRICAS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVCA_METRICAS-UPD_FLAG NE SPACE.
